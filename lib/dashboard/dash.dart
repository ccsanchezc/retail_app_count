          ...
          [
            Container
              ...
              child: Row
                ...
                children: <Widget>
                [
                  Text('enacloudtech.com', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
        ...
        body: StaggeredGridView.count(
          ...
          children: <Widget>[
            ...
            _buildTile(
              ...
              onTap: () => ( print("TAP") )// Navigator.of(context).push(MaterialPageRoute(builder: (_) => ShopItemsPage())),
            )
          ],
          staggeredTiles: [
